...
namespace moho
{
  ...
  void CUnitLoadUnitsTypeInfo::Init()
  {
    ...
    newRefFunc_ = &CUnitLoadUnitsTypeInfo::NewRef;
    ctorRefFunc_ = &CUnitLoadUnitsTypeInfo::CtrRef;
    deleteFunc_ = &CUnitLoadUnitsTypeInfo::Delete;
    dtrFunc_ = &CUnitLoadUnitsTypeInfo::Destruct;
    gpg::RType::Init();
