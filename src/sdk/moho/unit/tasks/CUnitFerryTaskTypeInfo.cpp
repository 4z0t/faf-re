...
namespace moho
{
  ...
  void CUnitFerryTaskTypeInfo::Init()
  {
    ...
    newRefFunc_ = &CUnitFerryTaskTypeInfo::NewRef;
    ctorRefFunc_ = &CUnitFerryTaskTypeInfo::CtrRef;
    deleteFunc_ = &CUnitFerryTaskTypeInfo::Delete;
    dtrFunc_ = &CUnitFerryTaskTypeInfo::Destruct;
    gpg::RType::Init();
